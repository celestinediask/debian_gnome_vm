...
sudo apt update && sudo apt install -y --no-install-suggests --no-install-recommends gnome-session gdm3 gnome-terminal xdg-utils gnome-shell-extension-dash-to-panel spice-vdagent xorg xdotool
enable_autologin
disable_wayland
